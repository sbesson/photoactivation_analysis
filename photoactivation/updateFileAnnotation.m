function updateFileAnnotation(session, fileAnnotation, filePath)
% UPDATEFILEANNOTATION Upload a file and create a file annotation on the OMERO server
%
%    fa = updateFileAnnotation(session, filePath) uploads the file specified
...
ip.parse(session, fileAnnotation, filePath);
...
originalFile = fileAnnotation.getFile;
